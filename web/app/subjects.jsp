    ...
    <div class="row">
      <div class="col-lg-12">
        <%
          ...
          SubjectSet subs = DbHelper.getSubjectSet(offset,limit);
        %>
          ...
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              <%
                ...
                Integer sid =0;
                while (subs.next()){
                  Subject subject = subs.getSubject();
                  sid = subject.getId();                %>
              <tr>
                <td><%out.print(x);%></td>
                <td><a href="subject.jsp?id=<%=sid%>"><%=subject.getName()%></a> </td>
              </tr>
              <%
                  x++;
                }
              ...
              <button type="submit" class="btn btn-default"><a
                      href="subjects.jsp?offset=<%=offset-limit%>">Previous
                page</a></button>
              <button type="submit" class="btn btn-default"><a
                      href="subjects.jsp?offset=<%=offset+limit%>">Next
                page</a></button>
            </table>
          </div>
          <!-- /.table-responsive -->
