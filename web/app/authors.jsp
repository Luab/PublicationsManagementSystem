            ...
            <div class="col-lg-12">
                <%
                    ...
                    if (Objects.equals(par, "")){
                        response.sendRedirect("error.jsp?from=\"No such authors\"");
                        i=1;
                    }
                    else {
                        i = Integer.parseInt(par);
                    }
                    AuthorSet auths = DbHelper.getAuthorSet(offset,limit);
                %>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td><%out.print(x);%></td>
                                <td><a href="author.jsp?id=<%=auth.getId()%>"><%=auth.getName()%></a> </td>
                            </tr>
                            <%
                                    x++;
                                }
                            ...
                            <button type="submit" class="btn btn-default"><a
                                    href="authors.jsp?offset=<%=offset-limit%>">Previous
                                page</a></button>
                            <button type="submit" class="btn btn-default"><a
                                    href="authors.jsp?offset=<%=offset+limit%>">Next
                                page</a></button>
                        </table>
                    </div>
                    <!-- /.table-responsive -->
